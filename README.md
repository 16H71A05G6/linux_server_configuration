...
# IP Address
IP Address: 13.233.106.16

# Host Name
Host Name: ec2-13-233-106-16.ap-south-1.compute.amazonaws.com
...
2. Now we have to move/copy our **.pem** file into **.ssh** folder. I've saved my file as **t.pem**. To move/copy our **.pem** file follow below command.
...
4. Now we use this key to log into our Amazon Lightsail server
        ...
        3. sudo ssh -i ~/.ssh/YOURFILENAME.pem ubuntu@13.233.106.16
...
18. Log into the server as grader
        ...
        21. ssh -i ~/.ssh/udacity_key.rsa grader@13.233.106.16
...
and then log back through port 2200:
        ...
        27. ssh -i ~/.ssh/udacity_key.rsa -p 2200 grader@13.233.106.16
...
paste the following code and save
        ...
        <VirtualHost *:80>
            ...
            ServerAdmin admin@13.233.106.16
